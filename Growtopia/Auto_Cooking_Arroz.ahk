...
ifExist,%A_Temp%\version.txt
{
   ...
   URLDownloadToFile,https://raw.githubusercontent.com/Siynk/Version/main/Version.txt,%A_Temp%\version.txt
   break
}
}
...
if (versionvalue="Version-August-27-2021"){
...
Gui,Main:Add,ListView,y+5 w105 r9 vOvenList,x|y 
...
Gui,Main:Add,Button,x10 y280 w105 h40 gRemove,Remove Coordinate
